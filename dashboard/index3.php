<?php require_once "vistas/parte_superior3.php"?>
...
<div class="container">
    <p> Colegio Madre Emilia
        ...
        <br>
        <br>
        <h1 style="text-align:center">¿Qué vamos a supervisar hoy?</h1>
        <img class="imagen" src="img/fondo3.jpg" width="700" height="400">
